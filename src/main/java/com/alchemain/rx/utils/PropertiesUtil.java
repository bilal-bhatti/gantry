...
public class PropertiesUtil {
	...
	static {
		try {
			log.info("Initializing Kasba web application properties");
			InputStream stream = PropertiesUtil.class.getClassLoader().getResourceAsStream("Kasba.properties");
			...
			throw new RuntimeException("Missing Kasba.properties file. Make sure the file is on the classpath", e);
		}
	}
